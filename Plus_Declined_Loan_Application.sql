--- It is important to differentiate between decliend card appication and declined loan application. This definition was first suggested during FEB code red in 2023 and further enhanced. It contains the declines that are part of the "Afterpay brain" decision--
...
(and type = 'AUTH' AND country_code = 'US')
---(and type in ('AUTH', 'PDBT) AND country_code = 'AU') -- different logic here for AU
